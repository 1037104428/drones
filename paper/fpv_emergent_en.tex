...
Fire at the nearest in-range, unlocked enemy (ties by id). About 9 ops. No friend geometry.
...
Greedy/net rise from 10.23 to 11.30 kills (denser coverage near the origin). The friend rule remains more conservative ($p\sim 10^{-16}$ on survival). The net again copies greedy. CSV: \texttt{results/gaussian/}.
